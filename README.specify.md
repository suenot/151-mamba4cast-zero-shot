# Chapter 130: Mamba4Cast Zero-Shot

## Описание

Zero-shot foundation model на базе Mamba для time series.
...
1. **Mamba4Cast: Efficient Zero-Shot Time Series Forecasting with State Space Models**
